...
import CV_PDF_FR from './Theo_JULIEN_FR_CV.pdf';
            ...
            <div className="body_APropos">
                ...
                <div className="bannerText">
                    <div className={this.state.paragraphe==0?"active":""}>
                        ...
                        in June 2020, I am now in the third year of the engineering cycle at CY Tech (ex-EISTI) so in my five year after the baccalaureate.</p>
                    </div>
                    ...
                    <div className={this.state.paragraphe==2?"active":""}>
                        ...
                        I do coach groups of skaters and I judge a few competitions. From 2020 to 2022 I was an ambassador of my school, I represented 
                        ...
                        I like the social contact with other people who want to discover my school. From 2020 to 2021 I was a tutor at Parkours, I 
                        went to middle schools to help people with their homeworks in small groups (usually 5 students). As you will have understood, 
